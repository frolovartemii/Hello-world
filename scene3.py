...
def scene3_frame_4(e, f, sunpriest_key, Key, race, poach, powder_case, powder_poach, sugar, money):
    a = ""
    b = ""
    c = ""
    f = 0
            ...
            if sunpriest_key == True:
                ...
                if e == 1:
                    while c != "1":
                        ...
                        if f == 1 and powder_case == False:
                            print(" 2 - Взять ящик с порохом.")
                            if poach == True and powder_case == False:
                        ...
                        if c == "2" and f == 1:
                            if powder_poach == True:
                                ...
                                powder_poach = False
                            print(" Вы поднимаете ящик с порохом. Ящик громоздсикй, так что пролезет он не везде, и во время взаимодействия с другими местами или предметами вы будете ставить его рядом и поднимать по окончанию взаимодействия.")
                            powder_case = True
                        if c == "3" and f == 1 and powder_case == False:
                            if sugar == True:
...
def scene3_frame_5(g, flour, powder_poach, money, sugar):
    g = 0
    b = ""
    if g == 0:
