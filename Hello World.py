    ...
    while main_exit == False:
        ...
        if backtracking_4 == False:
            while main_exit == False:
                ...
                if choise == "2" and rise == True:
                    rise, backtracking_1, backtracking_2, backtracking_4 = input(rise, backtracking_1, backtracking_2, backtracking_4)
                if choise == "3" and body_3 == False:
                if choise == "4" and body_3 == True:
