        ...
        if backtracking_4 == False:
            while main_exit == False:
                ...
                if choise == "1" and third_hall == False:
                    ...
                    body_3, Head, Margancovka, sunpriest_key, poach = scene4.scene4_frame_4(body_3, name, race, Head, Margancovka, sunpriest_key, poach)
                elif choise == "3" and body_3 == True:
                    sugar, sugar_poach, main_exit = scene4.scene4_frame_5(name, sugar, sugar_poach, main_exit, powder_case_BOOM, Margancovka)
